...
/**
 @author Nandhakumar
 */
public class FindNetworkOfOrderItemsTest extends BaseTest {
    private FindNetworkOfOrderItems rule;
    private static String filePath = PATH_PREFIX + FIND_NETWORK_OF_ORDER_ITEMS + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new FindNetworkOfOrderItems();
    }
