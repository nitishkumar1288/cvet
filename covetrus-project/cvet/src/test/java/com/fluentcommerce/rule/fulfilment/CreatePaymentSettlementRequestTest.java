...
public class CreatePaymentSettlementRequestTest extends BaseTest {
    private CreatePaymentSettlementRequest rule;
    private static  String filePath = PATH_PREFIX_FULFILMENT + CREATE_PAYMENT_SETTLEMENT_REQUEST + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new CreatePaymentSettlementRequest();
    }

    @Test
    public void testClass() throws Exception{
        String className =  CreatePaymentSettlementRequest.class.getSimpleName();
        // SETUP
        mockEvent();
