...
import com.fluentcommerce.rule.webhook.fulfilment.SendFulfillmentWebhook;
...
public class SendFulfillmentWebhookTest extends BaseTest {
    private SendFulfillmentWebhook rule;
    private static  String filePath = PATH_PREFIX_WEBHOOK + SEND_FULFILLMENT_WEBHOOK + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new SendFulfillmentWebhook();
    }

    @Test
    public void testClass() throws Exception{
        String className =  SendFulfillmentWebhook.class.getSimpleName();
        // SETUP
        mockEvent();
