...
/**
 @author Nandhakumar
 */
public class UpdateHillOrderLineItemsStatusAndLocationInformationTest extends BaseTest {
    private UpdateHillOrderLineItemsStatusAndLocationInformation rule;
    private static String filePath = PATH_PREFIX + UPDATE_HILL_ORDER_LINE_ITEMS_STATUS_AND_LOCATION_INFORMATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateHillOrderLineItemsStatusAndLocationInformation();
    }

    @Test
    public void testClass() throws Exception {
        String className = UpdateHillOrderLineItemsStatusAndLocationInformation.class.getSimpleName();
        mockEvent();
