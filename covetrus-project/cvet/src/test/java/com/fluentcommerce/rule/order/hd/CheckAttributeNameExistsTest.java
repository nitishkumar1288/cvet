...
import com.fluentcommerce.rule.order.common.CheckAttributeNameExists;
...
public class CheckAttributeNameExistsTest extends BaseTest {
    private CheckAttributeNameExists rule;
    private static  String filePath = PATH_PREFIX+CHECK_ATTRIBUTE_NAME_EXISTS+BACK_SLASH+SCENARIO_1
            +BACK_SLASH;

    @Before
    public void setUp() {
        rule = new CheckAttributeNameExists();
    }

    @Test
    public void testClass() throws Exception{

        String className =  CheckAttributeNameExists.class.getSimpleName();
