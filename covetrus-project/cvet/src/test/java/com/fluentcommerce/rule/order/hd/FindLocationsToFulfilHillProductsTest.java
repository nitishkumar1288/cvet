...
import com.fluentcommerce.rule.order.allocation.hillitems.FindLocationsToFulfilHillProducts;
...
/**
 @author Nandhakumar
 */
public class FindLocationsToFulfilHillProductsTest extends BaseTest {
    private FindLocationsToFulfilHillProducts rule;
    private static String filePath = PATH_PREFIX + FIND_LOCATIONS_TO_FULFIL_HILL_PRODUCTS + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new FindLocationsToFulfilHillProducts();
    }

    @Test
    public void testClass() throws Exception {
        String className = FindLocationsToFulfilHillProducts.class.getSimpleName();
        mockEvent();
