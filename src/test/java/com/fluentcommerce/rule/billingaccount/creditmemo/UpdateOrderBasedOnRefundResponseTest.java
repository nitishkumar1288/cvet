...
public class UpdateOrderBasedOnRefundResponseTest extends BaseTest {
    private UpdateOrderBasedOnRefundResponse rule;
    private static  String filePath = PATH_PREFIX_CREDIT_MEMO + UPDATE_ORDER_BASED_ON_REFUND_RESPONSE + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateOrderBasedOnRefundResponse();
    }

    @Test
    public void testClass() throws Exception{
        String className =  UpdateOrderBasedOnRefundResponse.class.getSimpleName();
        // SETUP
        mockEvent();
