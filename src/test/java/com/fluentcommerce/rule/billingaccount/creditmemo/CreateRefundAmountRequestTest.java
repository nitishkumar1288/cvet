...
public class CreateRefundAmountRequestTest extends BaseTest {
    private CreateRefundAmountRequest rule;
    private static  String filePath = PATH_PREFIX_CREDIT_MEMO + CREATE_REFUND_MOUNT_REQUEST + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new CreateRefundAmountRequest();
    }

    @Test
    public void testClass() throws Exception{
        String className =  CreateRefundAmountRequest.class.getSimpleName();
        // SETUP
        mockEvent();
