...
public class UpdateCreditMemoForRequestedRefundAmountTest extends BaseTest {
    private UpdateCreditMemoForRequestedRefundAmount rule;
    private static  String filePath = PATH_PREFIX_CREDIT_MEMO + UPDATE_CREDIT_MEMO_FOR_REQUESTED_REFUND_AMOUNT + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateCreditMemoForRequestedRefundAmount();
    }

    @Test
    public void testClass() throws Exception{
        String className =  UpdateCreditMemoForRequestedRefundAmount.class.getSimpleName();
        // SETUP
        mockEvent();
