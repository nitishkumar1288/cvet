...
public class SendEventBasedOnRefundTypeTest extends BaseTest {
    private SendEventBasedOnRefundType rule;
    private static  String filePath = PATH_PREFIX_CREDIT_MEMO + SEND_EVENT_BASED_ON_REFUND_TYPE + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new SendEventBasedOnRefundType();
    }

    @Test
    public void testClass() throws Exception{
        String className =  SendEventBasedOnRefundType.class.getSimpleName();
        // SETUP
        mockEvent();
