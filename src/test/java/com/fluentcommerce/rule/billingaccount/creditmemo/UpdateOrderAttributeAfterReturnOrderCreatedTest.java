...
public class UpdateOrderAttributeAfterReturnOrderCreatedTest extends BaseTest {
    private UpdateOrderAttributeAfterReturnOrderCreated rule;
    private static  String filePath = PATH_PREFIX_CREDIT_MEMO + UPDATE_ORDER_ATTRIBUTE_AFTER_RETURN_ORDER_CREATED + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateOrderAttributeAfterReturnOrderCreated();
    }

    @Test
    public void testClass() throws Exception{
        String className =  UpdateOrderAttributeAfterReturnOrderCreated.class.getSimpleName();
        // SETUP
        mockEvent();
