...
import com.fluentcommerce.rule.webhook.order.SendCashSaleWebhook;
...
public class SendCashSaleWebhookTest extends BaseTest {
    private SendCashSaleWebhook rule;
    private static  String filePath = PATH_PREFIX_WEBHOOK + SEND_CASH_SALE_WEBHOOK + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new SendCashSaleWebhook();
    }

    @Test
    public void testClass() throws Exception{
        String className =  SendCashSaleWebhook.class.getSimpleName();
        // SETUP
        mockEvent();
