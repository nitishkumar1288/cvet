...
public class UpdateOrderItemAsPaymentSettlementCompletedTest extends BaseTest {
    private UpdateOrderItemAsPaymentSettlementCompleted rule;
    private static String filePath = PATH_PREFIX_FULFILMENT + UPDATE_ORDER_ITEMS_AS_PAYMENT_SETTLEMENT_COMPLETED + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateOrderItemAsPaymentSettlementCompleted();
    }

    @Test
    public void testClass() throws Exception {
        String className = UpdateOrderItemAsPaymentSettlementCompletedTest.class.getSimpleName();
