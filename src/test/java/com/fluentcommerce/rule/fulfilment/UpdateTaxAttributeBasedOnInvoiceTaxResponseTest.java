...
public class UpdateTaxAttributeBasedOnInvoiceTaxResponseTest extends BaseTest {
    private UpdateTaxAttributeBasedOnInvoiceTaxResponse rule;
    private static  String filePath = PATH_PREFIX_FULFILMENT + UPDATE_TAX_ATTRIBUTE_BASED_ON_INVOICE_TAX_RESPONSE + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateTaxAttributeBasedOnInvoiceTaxResponse();
    }

    @Test
    public void testClass() throws Exception {
        String className = UpdateTaxAttributeBasedOnInvoiceTaxResponse.class.getSimpleName();
        //mock data
        mockEvent();
        ...
        //VERIFICATION
        VerificationUtils.verifyMutationClass(UpdateOrderMutation.class,context,2);
    }
