...
import com.fluentcommerce.rule.order.allocation.rxitems.AssignLocationToOrderItemBasedOnPriority;
...
/**
 @author Nandhakumar
 */
public class AssignLocationToOrderItemBasedOnPriorityTest extends BaseTest {
    private AssignLocationToOrderItemBasedOnPriority rule;
    private static String filePath = PATH_PREFIX + ASSIGN_LOCATION_TO_ORDER_ITEM_BASED_ON_PRIORITY + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new AssignLocationToOrderItemBasedOnPriority();
    }

    @Test
    public void testClass() throws Exception {
        String className = AssignLocationToOrderItemBasedOnPriority.class.getSimpleName();
        mockEvent();
