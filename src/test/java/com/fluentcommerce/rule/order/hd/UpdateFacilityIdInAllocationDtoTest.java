...
import com.fluentcommerce.rule.order.allocation.rxitems.UpdateFacilityIdInAllocationDto;
...
public class UpdateFacilityIdInAllocationDtoTest extends BaseTest {
    private UpdateFacilityIdInAllocationDto rule;
    private static  String filePath = PATH_PREFIX + UPDATE_FACILITY_ID_IN_ALLOCATION_DTO +
            BACK_SLASH + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateFacilityIdInAllocationDto();
    }

    @Test
    public void testClass() throws Exception{
        String className = UpdateFacilityIdInAllocationDtoTest.class.getSimpleName();
