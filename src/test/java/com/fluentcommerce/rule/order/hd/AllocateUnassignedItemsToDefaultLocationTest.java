...
import com.fluentcommerce.rule.order.allocation.rxitems.AllocateUnassignedItemsToDefaultLocation;
...
/**
 @author Nandhakumar
 */
public class AllocateUnassignedItemsToDefaultLocationTest extends BaseTest {
    private AllocateUnassignedItemsToDefaultLocation rule;
    private static String filePath = PATH_PREFIX + ALLOCATE_UNASSIGNED_ITEMS_TO_DEFAULT_LOCATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new AllocateUnassignedItemsToDefaultLocation();
    }
