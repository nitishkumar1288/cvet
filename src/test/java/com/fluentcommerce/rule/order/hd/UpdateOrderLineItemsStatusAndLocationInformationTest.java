...
import com.fluentcommerce.rule.order.allocation.rxitems.UpdateOrderLineItemsStatusAndLocationInformation;
...
/**
 @author Nandhakumar
 */
public class UpdateOrderLineItemsStatusAndLocationInformationTest extends BaseTest {
    private UpdateOrderLineItemsStatusAndLocationInformation rule;
    private static String filePath = PATH_PREFIX + UPDATE_ORDER_LINE_ITEMS_STATUS_AND_LOCATION_INFORMATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateOrderLineItemsStatusAndLocationInformation();
    }
