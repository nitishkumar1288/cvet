...
import com.fluentcommerce.rule.order.allocation.otcitems.FindLocationForOtcProductsFromRxLocation;
...
/**
 @author Nandhakumar
 */
public class FindLocationForOtcProductsFromRxLocationTest extends BaseTest {
    private FindLocationForOtcProductsFromRxLocation rule;
    private static String filePath = PATH_PREFIX + FIND_LOCATION_FOR_OTC_PRODUCTS_FROM_RX_LOCATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new FindLocationForOtcProductsFromRxLocation();
    }

    @Test
    public void testClass() throws Exception {
        String className = FindLocationForOtcProductsFromRxLocation.class.getSimpleName();
        mockEvent();
