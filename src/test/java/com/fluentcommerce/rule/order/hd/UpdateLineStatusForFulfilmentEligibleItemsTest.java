...
import com.fluentcommerce.rule.order.createfulfilment.UpdateLineStatusForFulfilmentEligibleItems;
...
public class UpdateLineStatusForFulfilmentEligibleItemsTest extends BaseTest {
    private UpdateLineStatusForFulfilmentEligibleItems rule;
    private static  String filePath = PATH_PREFIX + UPDATE_LINE_STATUS_FOR_FULFILMENT_ELIGIBLE_ITEMS + BACK_SLASH + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new UpdateLineStatusForFulfilmentEligibleItems();
    }

    @Test
    public void testClass() throws Exception{
        String className = UpdateLineStatusForFulfilmentEligibleItems.class.getSimpleName();
        // SETUP
        mockEvent();
    ...
    private void mockParameters(String className) {
        ...
        when(context.getProp(PV1_VERIFIED)).thenReturn(TRUE);
    }
