...
/**
 @author Nandhakumar
 */
public class CheckNonPreAssignedFacilityItemsInAllocationTest extends BaseTest {
    private CheckNonPreAssignedFacilityItemsInAllocation rule;
    private static String filePath = PATH_PREFIX + CHECK_NON_PRE_ASSIGNED_FACILITY_ITEMS_IN_ALLOCATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new CheckNonPreAssignedFacilityItemsInAllocation();
    }
