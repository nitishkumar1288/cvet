...
import com.fluentcommerce.rule.order.allocation.dropshipitems.SendEventToUpdateInventoryQuantityFromDropShipOrderItems;
...
public class SendEventToUpdateInventoryQuantityFromDropShipOrderItemsTest extends BaseTest {
    private SendEventToUpdateInventoryQuantityFromDropShipOrderItems rule;
    private static String filePath = PATH_PREFIX + SEND_EVENT_TO_UPDATE_INVENTORY_QUANTITY_FROM_DROP_SHIP_ORDER_ITEMS +BACK_SLASH + SCENARIO_1
            + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new SendEventToUpdateInventoryQuantityFromDropShipOrderItems();
    }
