...
import com.fluentcommerce.rule.order.allocation.hillitems.SendEventWithHillOrderItemInformation;
...
/**
 @author Nandhakumar
 */
public class SendEventWithHillOrderItemInformationTest extends BaseTest {
    private SendEventWithHillOrderItemInformation rule;
    private static String filePath = PATH_PREFIX + SEND_EVENT_WITH_HILL_ORDER_ITEM_INFORMATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new SendEventWithHillOrderItemInformation();
    }

    @Test
    public void testClass() throws Exception {
        String className = SendEventWithHillOrderItemInformation.class.getSimpleName();
        mockEvent();
