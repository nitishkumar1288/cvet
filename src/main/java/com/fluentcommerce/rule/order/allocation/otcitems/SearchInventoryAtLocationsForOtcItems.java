 ...
 */
@RuleInfo(
        name = "SearchInventoryAtLocationsForOtcItems",
...
@EventAttribute(name = PRODUCT_REF_LIST_OTC_ITEMS)
@Slf4j
public class SearchInventoryAtLocationsForOtcItems extends BaseRule {
    ...
    public void run(ContextWrapper context) {
        ...
        List<String> productRefsOfOtcItems = ( List<String>)eventAttribute.get(PRODUCT_REF_LIST_OTC_ITEMS);
        ...
        if(locations.size() == 0){
            ...
            virtualPositions = virtualService.searchVirtualPositions(virtualCatalogueRef, new ArrayList<>(locations.keySet()), productRefsOfOtcItems);
        }
