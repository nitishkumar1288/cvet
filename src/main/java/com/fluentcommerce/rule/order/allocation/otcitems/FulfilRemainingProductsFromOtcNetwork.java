...
@RuleInfo(
        ...
        description = "Fulfil the remaining products from the otc network and send event {" + PROP_EVENT_NAME + "}.",
        produces = {
                @EventInfo(
                        eventName = "{eventName}",
...
@Slf4j
public class FulfilRemainingProductsFromOtcNetwork extends BaseRule {
    ...
    public void run(ContextWrapper context) {
        ...
        // step 1: find the location which can satisfy the maximum number of products
    ...
    private static void forwardInlineEvent(
            ContextWrapper context,
            String eventName) {
