...
import com.fluentcommerce.rule.order.allocation.rxitems.FindKitProductsInAllocationProcess;
...
/**
 @author Nandhakumar
 */
public class FindKitProductsInAllocationProcessTest extends BaseTest {
    private FindKitProductsInAllocationProcess rule;
    private static String filePath = PATH_PREFIX + FIND_KIT_PRODUCTS_IN_ALLOCATION_PROCESS_TEST + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new FindKitProductsInAllocationProcess();
    }

    @Test
    public void testClass() throws Exception {
        String className = FindKitProductsInAllocationProcess.class.getSimpleName();
        mockEvent();
