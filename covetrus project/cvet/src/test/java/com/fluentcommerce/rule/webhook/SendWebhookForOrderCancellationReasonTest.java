...
public class SendWebhookForOrderCancellationReasonTest extends BaseTest {
    ...
    private static  String filePath = PATH_PREFIX_WEBHOOK + SEND_WEBHOOK_FOR_ORDER_CANCELLATION_REASON + BACK_SLASH +
    ...
    public void testClass() throws Exception{
        String className =  SendWebhookForOrderCancellationReason.class.getSimpleName();
        // SETUP
        mockEvent();
