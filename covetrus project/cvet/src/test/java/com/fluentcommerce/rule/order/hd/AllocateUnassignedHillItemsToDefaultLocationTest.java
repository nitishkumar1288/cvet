...
import com.fluentcommerce.rule.order.allocation.hillitems.AllocateUnassignedHillItemsToDefaultLocation;
...
/**
 @author Nandhakumar
 */
public class AllocateUnassignedHillItemsToDefaultLocationTest extends BaseTest {
    private AllocateUnassignedHillItemsToDefaultLocation rule;
    private static String filePath = PATH_PREFIX + ALLOCATE_UNASSIGNED_HILL_ITEMS_TO_DEFAULT_LOCATION + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new AllocateUnassignedHillItemsToDefaultLocation();
    }

    @Test
    public void testClass() throws Exception {
        String className = AllocateUnassignedHillItemsToDefaultLocation.class.getSimpleName();
        mockEvent();
