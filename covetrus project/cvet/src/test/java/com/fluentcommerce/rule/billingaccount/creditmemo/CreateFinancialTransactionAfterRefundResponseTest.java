...
public class CreateFinancialTransactionAfterRefundResponseTest extends BaseTest {
    private CreateFinancialTransactionAfterRefundResponse rule;
    private static  String filePath = PATH_PREFIX_CREDIT_MEMO + CREATE_FINANCIAL_TRANSACTION_AFTER_REFUND_RESPONSE + BACK_SLASH +
            SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new CreateFinancialTransactionAfterRefundResponse();
    }

    @Test
    public void testClass() throws Exception{
        String className =  CreateFinancialTransactionAfterRefundResponse.class.getSimpleName();
        // SETUP
        mockEvent();
