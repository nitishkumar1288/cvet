...
import com.fluentcommerce.rule.order.common.cancelreason.CaptureCancelledOrderItemReasonFromExceptionResolution;
...
public class CaptureCancelledOrderItemReasonFromExceptionResolutionTest extends BaseTest {
    private CaptureCancelledOrderItemReasonFromExceptionResolution rule;
    private static  String filePath = PATH_PREFIX+CAPTURE_CANCELLED_ORDER_ITEM_REASON_FROM_EXCEPTION_RESOLUTION+BACK_SLASH+SCENARIO_1
            +BACK_SLASH;

    @Before
    public void setUp() {
        rule = new CaptureCancelledOrderItemReasonFromExceptionResolution();
    }

    @Test
    public void testClass() throws Exception{
        String className =  CaptureCancelledOrderItemReasonFromExceptionResolution.class.getSimpleName();
