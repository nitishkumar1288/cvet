...
import com.fluentcommerce.rule.order.allocation.hillitems.FindKitProductsInAllocationProcessOfHillItems;
...
/**
 @author Nandhakumar
 */
public class FindKitProductsInAllocationProcessOfHillItemsTest extends BaseTest {
    private FindKitProductsInAllocationProcessOfHillItems rule;
    private static String filePath = PATH_PREFIX + FIND_KIT_PRODUCTS_IN_ALLOCATION_PROCESS_OF_HILL_ITEMS + BACK_SLASH
            + SCENARIO_1 + BACK_SLASH;

    @Before
    public void setUp() {
        rule = new FindKitProductsInAllocationProcessOfHillItems();
    }

    @Test
    public void testClass() throws Exception {
        String className = FindKitProductsInAllocationProcessOfHillItems.class.getSimpleName();
        mockEvent();
